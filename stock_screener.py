...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="台股突破選股器 V3")
    parser.add_argument("-o", "--output", default="breakout_report.txt")
    ...
    report = run_and_get_report(max_workers=args.workers)
